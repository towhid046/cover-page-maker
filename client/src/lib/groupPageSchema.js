...
export const GROUP_PAGE_SCHEMA = z.object({
    ...
    groupNumber: z.string().trim().nonempty('Group Number can not be empty'),
    studentIds: z.string().trim().nonempty('Student ID can not be empty'),
